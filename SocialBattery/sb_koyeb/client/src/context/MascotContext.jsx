...
export const MASCOT_ACCESSORIES = [
  ...
  },
  {
    ...
    // horneado a canvas. No tocar una sin la otra: no hay "otra" — ambas
    // rutas leen este mismo valor.
    rinonBox: { left: 20.396, top: 68.864, width: 57.984, height: 37.207 },
  },
  {
    id: 'acc_rinon_azul',
    name: 'Riñonera azul',
  ...
  },
  {
    ...
    // horneado a canvas. No tocar una sin la otra: no hay "otra" — ambas
    // rutas leen este mismo valor.
    rinonBox: { left: 20.396, top: 68.793, width: 57.984, height: 37.414 },
  },
  {
...
export const MASCOT_FEET = [
  ...
  },
  {
    ...
    // Bajada un poco más (5% → 7% → 12% → 17% → 20%) y reducida un 10% adicional junto con
  ...
  },
  {
    ...
    // Ítem definitivo, el más caro de toda la tienda.
    price: 500,
    isBase: false,
...
export function MascotProvider({ children }) {
  ...
  function equipActivity(id) {
    setActiveActivity(current => (current === id ? 'none' : id));
  }
  ...
  function equipOutfit(id) {
    setActiveOutfit(current => (current === id ? 'out_none' : id));
  }
  ...
  function equipFeet(id) {
    setActiveFeet(current => (current === id ? 'feet_none' : id));
  }
  ...
  function equipHead(id) {
    setActiveHead(current => (current === id ? 'head_none' : id));
  }
