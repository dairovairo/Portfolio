...
function CreatePoolModal({ onClose, onCreate }) {
  const minDate = formatInputDateTime(new Date(Date.now() + 30 * 60 * 1000)); // 30 min from now
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: Café en el centro, Fútbol 5, Cine..."
              maxLength={100}
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Más detalles sobre el plan..."
              maxLength={300}
              rows={2}
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: Plaza Mayor, cerca de la estación..."
              maxLength={150}
              className="w-full bg-surface-bg border border-surface-border rounded-xl px-4 py-3 text-surface-text placeholder-slate-600 text-sm focus:outline-none focus:border-accent-primary/50 transition-colors"
            />
          </div>
          ...
          {/* Public toggle */}
          <div className="flex items-center justify-between bg-surface-bg border border-surface-border rounded-xl px-4 py-3">
            <div>
              <div className="text-sm font-display text-surface-text">Pool público</div>
              <div className="text-xs text-surface-muted mt-0.5">
                Visible para cualquier usuario, no solo amigos
              </div>
            </div>
            <button
              type="button"
              ...
              className={`relative w-11 h-6 rounded-full transition-all duration-200 flex-shrink-0 ${
                form.is_public ? 'bg-accent-primary' : 'bg-slate-700'
              }`}
            >
              <span
