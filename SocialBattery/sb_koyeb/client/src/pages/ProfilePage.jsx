...
// Modal de eliminación de cuenta. Es un flujo aparte para no ensuciar el
// render principal y para poder tenerlo bien "acordonado" psicológicamente
// (fondo oscuro, texto claro sobre qué se pierde, exigir tecleo literal de
// "ELIMINAR").
