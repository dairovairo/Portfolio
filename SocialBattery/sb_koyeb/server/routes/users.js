...
router.patch('/me', requireAuth, async (req, res) => {
  const { avatar_url, bio, interests, show_interests, show_public_stats, show_badges, mascot_name, mute_new_pools, mute_pool_chats, mute_community_chats, mute_new_events, mute_event_recommendations } = req.body;
  const updates = {};
