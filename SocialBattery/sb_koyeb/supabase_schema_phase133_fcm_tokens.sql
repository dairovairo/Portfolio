...
-- server/lib/fcm.js and client/src/lib/nativePush.js.
...
-- Idempotent: dropear antes de crear para que este script se pueda re-correr
-- sin errores ("policy already exists"). CREATE POLICY no soporta IF NOT EXISTS.
