...
/**
 * Examen de tipo Desarrollo (o el segundo tipo que necesites)
 */
public class ExamenRestaDir extends Examen {
    
    public ExamenRestaDir(int preguntasTotales, int restaIndirecta, int numRespPosibles, 
	...
	protected void recorrerSituacion(int j,int diffMagicos) {
		...
		while(k<numerosMagicos.size()-1) {
			...
			for(int z=0;z<(k*diffMagicos+diffMagicos+j);z++) {
				arrayNewAns.add(2);
