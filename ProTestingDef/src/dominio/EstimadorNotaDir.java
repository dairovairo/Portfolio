...
public class EstimadorNotaDir extends EstimadorNota{
	 public EstimadorNotaDir(Examen examen) {
		  super(examen);
	    }
	@Override
	 public double esperanza (int opciones,int ratio) {
			double puntajeAcierto=(double) (10.0/(double) examen.getPreguntasTotales());
			double puntajeError= (double) (1.0/ratio);
			return puntajeAcierto/opciones-((opciones-1)*puntajeError/opciones);
		}
	      @Override 
